...
4. Keep one reflection so �Ϸ� ��� appears in �� ��� ����.
5. Confirm �� �Ұ�, ����� ���, ���� �� ��, and �Ϸ� ��� each show a category count.
...
8. Confirm �Բ� �˾ư��� �ܰ�, ������ �λ���Ʈ, and ���� �����ϱ� continue rendering from the updated snapshot.
9. Turn consent OFF and confirm �� ��� ���� hides stored category details behind the fallback management message.
10. Tap ����� ��� ��� ����� and confirm the app returns to the empty local-memory summary state.
...
2. Turn ��� �ȿ� ����ϱ� ON so role-based local-memory UI remains active.
3. Select ģ��, ��ġ, ��û��, and ������ in turn and confirm the current-role context line changes in Korean.
...
5. Confirm ������ �λ���Ʈ changes its ����/���� �̼� tone by role without claiming certainty or diagnosis.
6. Confirm ���� �����ϱ� changes its ������ ����/ù ��° ���� �ൿ/���� ���� by role.
...
2. Confirm the visible section order reads naturally as:
   ...
   - �� ��� ����
   - ��ü �ʱ�ȭ
3. Confirm ������ �λ���Ʈ appears before ���� �����ϱ�.
4. Confirm �� ��� ���� stays reachable through an explicit expand/collapse control and does not crowd the main entry flow.
