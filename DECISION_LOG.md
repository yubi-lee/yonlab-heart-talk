...
| DEC-007 | 2026-06-22 | 최초 MVP 001 scaffold는 `Synthetic PPG Heart Rate Dashboard`로 생성 | 개인정보·센서 리스크를 낮춘 technical validation slice로 출발 | Superseded |
...
| DEC-010 | 2026-06-22 | Product MVP 001을 `Synthetic PPG Heart Rate Dashboard`에서 `Daily Reflection Companion Demo`로 변경 | 사용자 거부감, 개인정보·권한 리스크, 초기 제품 가치 검증 우선순위 | Accepted |
| DEC-011 | 2026-06-22 | `Synthetic PPG Heart Rate Dashboard`를 후속 technical validation slice로 이동 | PPG/신호 분석은 장기 방향이나 첫 제품 경험 검증에는 daily reflection이 더 적합 | Proposed |
